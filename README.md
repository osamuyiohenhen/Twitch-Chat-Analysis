[![CI for Twitch Chat Project](https://github.com/osamuyiohenhen/Twitch-Chat-Analysis/actions/workflows/test.yml/badge.svg)](https://github.com/osamuyiohenhen/Twitch-Chat-Analysis/actions/workflows/test.yml)
